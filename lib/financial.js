...
async function getFinancialData() {
  ...
  // 2025-01-01 00:00 Bangkok = 2024-12-31 17:00 UTC
  const startDate = new Date(Date.UTC(currentYear - 1, 11, 31, 17, 0, 0)); // Dec 31 previous year, 17:00 UTC = Jan 1, 00:00 Bangkok
  const endDate = new Date(Date.UTC(currentYear, 11, 31, 16, 59, 59)); // Dec 31, 16:59:59 UTC = Dec 31, 23:59:59 Bangkok

  // Fetch all financial records for the current year
